...
git add data/polla_historial.csv docs/data/loto_metrics.json docs/data/pozos.json data/loto_suggestions_pending.json data/suggestions_history.csv docs/data/suggestions_history.json docs/data/suggestions_detail.json
